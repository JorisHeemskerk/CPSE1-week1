...
TEST_CASE( "add various, check max" ){
    setOfThings<int, 10> s;
    s.add(1);
    s.add(-6);
    s.add(43646);
...
TEST_CASE( "add various strings, check max" ){
    setOfThings<char, 10> s;
    s.add('f');
    s.add('b');
    s.add('A');
    s.add('F');
...
TEST_CASE( "add various charssss, check max" ){
    setOfThings<std::array<char,3>, 10> s;
    s.add({'f', 'f', 'f'});
    s.add({'b', 'b', 'b'});
    s.add({'A', 'A', 'A'});
    s.add({'F', 'F', 'F'});
    REQUIRE( s.max() == std::array<char, 3>{'f', 'f', 'f'} ); 
}